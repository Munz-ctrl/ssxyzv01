...
export const caseStudies = [
  ...
  },
  {
    ...
    media: { type: "video", src: MEDIA + "tylr.MP4", poster: null },
    gallery: [MEDIA + "complxt.png"],
    emblem: MEDIA + "tylrt.png",
  ...
  {
    id: "magic-johnson-animation",
    flagship: false,
    category: ["vfx"],
    title: "Magic Johnson — Animation",
    client: "Magic Johnson",
    year: null,
    role: null,
    brief: "A 3D animation piece created for Magic Johnson.",
    challenge: null,
    concept: null,
    execution: null,
    result: null,
    ...
    credits: null,
    press: [],
    media: { type: "video", src: MEDIA + "MJ.mov", poster: null },
    gallery: [],
    link: null,
  },
  {
    id: "air-jordan-3d-sneaker",
    flagship: false,
    category: ["vfx", "brand"],
    title: "Air Jordan — 3D Sneaker Rendition",
    client: "Jordan Brand",
    year: null,
    role: null,
    brief: "A 3D CGI rendition of an Air Jordan sneaker.",
    challenge: null,
    concept: null,
    execution: null,
    result: null,
    ...
    credits: null,
    press: [],
    media: { type: "video", src: MEDIA + "ajmet.MOV", poster: null },
    gallery: [MEDIA + "blkctthumb.gif"],
    link: null,
  },
  {
